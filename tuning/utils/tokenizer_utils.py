#https://raw.githubusercontent.com/instructlab/training/main/src/instructlab/training/tokenizer_utils.py
# Standard
...
if __name__ == "__main__":
    import os
    from transformers import AutoTokenizer
    setup_tokenizer(os.environ.get("TOKENIZER")).save_pretrained(os.environ.get("SAVE_PATH"))