...
def train(
    ...
    total_num_tokens = sum([len(x['input_ids']) for x in train_dataset])
    ...
    thruput = total_num_tokens*training_args.num_train_epochs/results.metrics["train_runtime"]/training_args.world_size
    print(thruput)
